...
import org.x2ools.t9apps.R;

import com.ynu.cyand.t9Lib.Blur;
...
public class ViewManagerService extends Service implements HandleView.CallBack {
    ...
    private static final int ANIMATE_TIME = 0;//
    public final static String ACTION_HIDE_VIEW = "ACTION_DETROY_VIEW";
    private static final int HANDLER_WIDTH = 0;//
	...
	private void createView() {
        if (mT9AppsView == null) {
            ...
            //背景模糊
//           // mT9AppsView.setBackground(
//            		new BitmapDrawable(
//            				Blur.fastblur(
//            						this,
//            						((BitmapDrawable)mT9AppsView.getBackground()).getBitmap(),
//            						10)));
//          //  mT9AppsView.getBackground().setAlpha(100);
